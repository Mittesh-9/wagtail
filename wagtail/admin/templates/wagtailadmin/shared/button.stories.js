...
const Template = ({ url }) => (<section id="buttons">
    <h2>Buttons</h2>
    ...
    <button type="button" className="button bicolor button--icon button-secondary">
      <span className="icon-wrapper">
        <svg className="icon icon-plus icon" aria-hidden="true">
          <use href="#icon-plus"/>
        </svg>
    ...
    <button type="button" className="button bicolor button--icon button-secondary" disabled>
      <span className="icon-wrapper">
        <svg className="icon icon-plus icon" aria-hidden="true">
          <use href="#icon-plus"/>
        </svg>
    ...
    <button type="button" className="button button-small bicolor button--icon" disabled>
      <span className="icon-wrapper">
        <svg className="icon icon-plus icon" aria-hidden="true">
          <use href="#icon-plus"/>
        </svg>
    ...
    <a href={url} className="button button-small bicolor button--icon button-secondary">
      <span className="icon-wrapper">
        <svg className="icon icon-plus icon" aria-hidden="true">
          <use href="#icon-plus"/>
        </svg>
    ...
    <button type="button" className="button button-small bicolor button--icon button-secondary">
      <span className="icon-wrapper">
        <svg className="icon icon-plus icon" aria-hidden="true">
          <use href="#icon-plus"/>
        </svg>
    ...
    <button type="button" className="button button-small bicolor button--icon button-secondary" disabled>
      <span className="icon-wrapper">
        <svg className="icon icon-plus icon" aria-hidden="true">
          <use href="#icon-plus"/>
        </svg>
    ...
    <button type="button" className="button button-small text-replace button--icon">
      <svg className="icon icon-cog icon" aria-hidden="true">
        <use href="#icon-cog"/>
      </svg>
      button element
    ...
    <button type="button" className="button button-longrunning" data-controller="w-progress" data-action="w-progress#activate" data-w-progress-duration-value="5000">
      <svg className="icon icon-spinner icon" aria-hidden="true">
        <use href="#icon-spinner"/>
      </svg>
      Click me 5s
    </button>
    <button type="button" className="button button-secondary button-longrunning" data-controller="w-progress" data-action="w-progress#activate" data-w-progress-duration-value="5000">
      <svg className="icon icon-spinner icon" aria-hidden="true">
        <use href="#icon-spinner"/>
      </svg>
      Click me 5s
    </button>
    <button type="button" className="button button-small button-longrunning" data-controller="w-progress" data-action="w-progress#activate" data-w-progress-duration-value="5000">
      <svg className="icon icon-spinner icon" aria-hidden="true">
        <use href="#icon-spinner"/>
      </svg>
      Click me 5s
    ...
    <button type="button" className="button button-longrunning" data-controller="w-progress" data-action="w-progress#activate" data-w-progress-duration-value="5000" data-w-progress-active-value="Test">
      <svg className="icon icon-spinner icon" aria-hidden="true">
        <use href="#icon-spinner"/>
      </svg>
      <em data-w-progress-target="label">Click me</em>
    </button>
    <button type="button" className="button disabled button-longrunning--active" data-controller="w-progress" data-action="w-progress#activate" data-w-progress-duration-value="5000">
      <svg className="icon icon-spinner icon" aria-hidden="true">
        <use href="#icon-spinner"/>
      </svg>
...
exports.All = Template.bind({});
exports.All.args = { url: window.location.toString() };
