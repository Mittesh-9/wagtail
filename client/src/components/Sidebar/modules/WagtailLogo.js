...
const WagtailLogo = ({ className, slim }) => {
    const feathersClasses = 'group-hover:w-text-black w-transition-all w-duration-150';
    return (<svg style={{
      ...
      `} width="430" height="537" viewBox="0 0 430 537" enableBackground="new 0 0 430 537" xmlSpace="preserve" aria-hidden="true">
      <g>
        <path className="wagtail-logo-face" fill="#FFF" d="M352.963,12.781l0.045,23.909c0,0-42.592-15.901-70.037,13.096
        ...
        <path className={`w-hidden ${feathersClasses}`} data-part="eye--closed" d="M343 77.2c14-16 33.8-7 33.8-7" fill="#261A4E" stroke="#231f20" strokeWidth="12"/>
        <path className={feathersClasses} data-part="eye--open" fill="currentColor" d="M371.838,71.336c0,6.016-4.877,10.893-10.893,10.893
		s-10.893-4.877-10.893-10.893c0-6.016,4.877-10.893,10.893-10.893S371.838,65.321,371.838,71.336"/>
        <path className={feathersClasses} data-part="body" fill="currentColor" d="M374 176s-14-69.4-104.4-50.7C260.6 94 262 71 282 49.8c27.5-29 70-13 70-13v-24C337 6.2 322.8 5 307 5c-58 0-90.3 43.3-104 72.8L39.4 378l46.2-8.6 19.3 24.2c127.6 0 291.7-46 269-217.7"/>

        <polygon className={feathersClasses} data-part="beak" fill="currentColor" points="429.948,117.665 393.96,83.063 365.567,117.665"/>
      ...
      <path className={feathersClasses} data-part="tail" fill="currentColor" d="M109 369.7l-22.4-4.3L2 528.4 61 518l45-128.4"/>
    </svg>);
};
exports.default = WagtailLogo;
